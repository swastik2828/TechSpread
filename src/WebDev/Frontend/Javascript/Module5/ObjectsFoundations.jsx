...
import ObjectVisualizer from "../../../../simulators/web/javascript/ObjectVisualizer";
...
const ObjectsFoundations = () => {
    ...
    return (
        <article className="max-w-5xl mx-auto text-gray-300 flex flex-col gap-6 sm:gap-8 leading-loose tracking-wide font-sans pb-16 sm:pb-20 w-full px-4 sm:px-0">
            <SEO
                title="Objects — Foundations | JavaScript Module 5"
                description="Understand JavaScript objects deeply. Learn how properties work, object methods, and flexible schemas."
                keywords="javascript objects, object keys, js objects visually, javascript object destructuring, property shorthand javascript"
                url="/webdevelopment/javascript/objects-foundations"
            />
            ...
            <header className="py-10 sm:py-16 md:py-24 text-center border-b border-white/10 mb-10 sm:mb-16 md:mb-20 relative overflow-hidden bg-gradient-to-b from-transparent to-black/20 rounded-b-[40px] w-full">
                ...
                <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: "easeOut" }} className="w-full">
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-amber-500/10 border border-amber-500/30 mb-6 sm:mb-8 backdrop-blur-sm shadow-[0_0_20px_rgba(251,191,36,0.2)]">
                        ...
                        <span className="text-amber-400 text-[10px] sm:text-xs md:text-sm font-black uppercase tracking-[0.15em] sm:tracking-[0.2em]">Module 5.3: Arrays & Objects</span>
                    </div>
                    <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black text-white mb-6 sm:mb-8 tracking-tighter drop-shadow-2xl px-2 w-full break-words">
                        Objects <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-yellow-500 to-orange-500">Foundations.</span>
                    </h1>
                </motion.div>
            </header>
            ...
            <div className="prose prose-invert prose-base sm:prose-lg max-w-none text-gray-300 w-full border-box">
                ...
                <Section title="5.3 Objects — Foundations" icon={Code2} id="foundations">
                    <p className="mb-4">
                        An object is a dynamic collection of key-value pairs called properties. Keys can be strings or Symbols; values can be any JavaScript value. Objects are the fundamental way JavaScript represents entities and structures. Unlike arrays, properties have no guaranteed order for most purposes (though modern engines do preserve insertion order for string keys in practice).
                    </p>
                    <p className="mb-4">
                        JavaScript objects are open and dynamic by default — you can add, modify, and delete properties at any time after creation. This flexibility is powerful for exploratory programming but demands discipline in professional code, where the expected shape of objects should be consistent and documented.
                    </p>

                    <HighlightBox title="Property Shorthand and Computed Keys" type="tip">
                        ES6 introduced property shorthand: when a variable's name matches the property key you want to create, you can write the name just once. Computed property names use an expression inside square brackets as the key — essential for building objects with dynamic, runtime-determined keys.
                    </HighlightBox>

                    <HighlightBox title="Object Methods" type="note">
                        Object.keys(obj) returns an array of the object's own enumerable string-keyed property names. Object.values(obj) returns the corresponding values. Object.entries(obj) returns an array of [key, value] pairs. These three methods, combined with array iteration methods, provide powerful patterns for transforming object-structured data.
                        <br/><br/>
                        Object.assign() copies properties from source objects into a target. Object.freeze() prevents any modifications to an object — its properties cannot be added, changed, or deleted. Object.create(proto) creates a new object with a specified prototype, which is how manual prototype-chain construction works.
                    </HighlightBox>

                    <div className="mt-16 mb-8 pt-8 border-t border-gray-800/60">
                        <h4 className="text-2xl sm:text-3xl font-black text-white mb-4">Interactive Object Visualizer</h4>
                        <p className="text-gray-400 mb-8">
                            Objects consist of key-value pairs stored dynamically on the heap. Use this visualizer to trace how objects are formed and how memory flows into scoped variables upon destructuring.
                        </p>
                        <ObjectVisualizer />
                    </div>
                ...
                <div className="mt-16 sm:mt-24 pt-8 sm:pt-12 border-t border-gray-800/60 text-center relative w-full">
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-6 sm:gap-4 w-full mx-auto">
                        <Link to="/webdevelopment/javascript/array-methods" className="group flex items-center gap-3 sm:gap-4 p-4 sm:p-5 rounded-xl sm:rounded-2xl bg-black/20 border border-gray-800 hover:border-gray-600 transition-all duration-300 w-full sm:w-auto self-start sm:self-auto order-2 sm:order-1">
                            ...
                            <div className="text-left w-full h-full">
                                ...
                                <span className="text-gray-300 font-bold text-xs sm:text-sm">Array Methods</span>
                            </div>
                        </Link>

                        <Link to="/webdevelopment/javascript/destructuring" className="group flex items-center gap-3 sm:gap-4 p-4 sm:p-5 rounded-xl sm:rounded-2xl bg-[#0a0c10] border border-gray-800 hover:border-amber-500/50 hover:shadow-[0_0_30px_rgba(251,191,36,0.1)] transition-all duration-300 w-full sm:w-auto order-1 sm:order-2">
                            <div className="text-right w-full h-full">
                                ...
                                <span className="text-gray-200 font-bold text-xs sm:text-sm group-hover:text-white transition-colors">Destructuring</span>
                            </div>
...
export default ObjectsFoundations;
