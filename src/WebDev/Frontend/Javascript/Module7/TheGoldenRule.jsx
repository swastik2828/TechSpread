...
import JsThisKeywordSimulator from "../../../../simulators/web/js/JsThisKeywordSimulator";
...
const TheGoldenRule = () => {
    return (
        <article className="max-w-5xl mx-auto text-gray-300 flex flex-col gap-6 sm:gap-8 leading-loose tracking-wide font-sans pb-16 sm:pb-20 w-full px-4 sm:px-0">
            <SEO
                title="The Golden Rule of this | JavaScript Course"
                description="Understand the 'this' keyword in JavaScript. Learn the golden rule: Stop asking where the function was written, and start asking how it was called."
                keywords="javascript this keyword, this context, golden rule of this, dynamic context javascript"
                url="/webdevelopment/javascript/the-golden-rule"
            />
            ...
            <header className="py-10 sm:py-16 md:py-24 text-center border-b border-white/10 mb-10 sm:mb-16 md:mb-20 relative overflow-hidden bg-gradient-to-b from-transparent to-black/20 rounded-b-[40px] w-full">
                ...
                <div className="w-full">
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-yellow-500/10 border border-yellow-500/30 mb-6 sm:mb-8 backdrop-blur-sm shadow-[0_0_20px_rgba(168,85,247,0.2)]">
                        ...
                        <span className="text-amber-400 text-[10px] sm:text-xs md:text-sm font-black uppercase tracking-[0.15em] sm:tracking-[0.2em]">Module 7.1: The Golden Rule</span>
                    </div>
                    ...
                    <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black text-white mb-6 sm:mb-8 tracking-tighter drop-shadow-2xl px-2 w-full break-words">
                        The <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-500 to-yellow-500">Golden Rule.</span>
                    </h1>
                    
                    <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-400 max-w-4xl mx-auto leading-relaxed font-light px-4">
                        Mastering the Shapeshifter: Why 'this' behaves differently in JavaScript compared to other languages.
                    </p>
                </div>
            </header>
            ...
            <div className="prose prose-invert prose-base sm:prose-lg max-w-none text-gray-300 w-full border-box">
                ...
                <Section title="Welcome to the 'this' Keyword" icon={BookOpen} id="intro">
                    <p className="text-lg sm:text-xl font-medium text-white leading-relaxed">
                        If you’re coming to JavaScript from languages like Java, C++, or Python, the <code>this</code> keyword will probably feel like it’s playing tricks on you. In most languages, <code>this</code> is predictable: it points to the blueprint (class) you are currently writing code inside.
                    </p>
                    <p className="text-gray-300 leading-relaxed mt-4">
                        In JavaScript, <code>this</code> is a shapeshifter. Its value is <strong>not fixed when you write the function</strong>. Instead, it is determined dynamically at the exact moment the function is executed.
                    </p>

                    <HighlightBox title="🔑 The Golden Rule of this" type="key">
                        Stop asking: "Where was this function written?"
                        <br/>
                        <strong className="text-yellow-400 text-xl mt-2 block">Start asking: "How was this function called?"</strong>
                    </HighlightBox>

                    <h3 className="text-2xl sm:text-3xl font-extrabold text-amber-400 mb-4 mt-10">
                        Why does this even exist?
                    </h3>
                    <p className="text-gray-300 leading-relaxed">
                        Before diving into the rules, it helps to understand why JavaScript works this way. The <code>this</code> keyword allows you to reuse the same function against multiple different objects. Instead of writing a separate <code>greet()</code> function for every single user, you write one generic function that uses <code>this</code> to magically adapt to whichever object is currently invoking it.
                    </p>

                    <div className="mt-8">
                        <CodeBlock 
                            title="reusability.js"
                            language="javascript"
                            code={`function greet() {
  // 'this' adapts to whoever calls it
  console.log(\`Hello, my name is \${this.name}\`);
}

const user1 = { name: "Alice", speak: greet };
const user2 = { name: "Bob", speak: greet };

// Same function, different context!
user1.speak(); // "Hello, my name is Alice"
user2.speak(); // "Hello, my name is Bob"`}
                        />
                    </div>

                    <p className="text-gray-300 leading-relaxed mt-8">
                        The 4 Rules of <code>this</code> (In Order of Precedence): When a regular JavaScript function is executed, the engine looks at the call site (the line of code where the function is invoked) and applies one of four rules to figure out what <code>this</code> should be. It checks these rules from most specific to least specific.
                    </p>
                    
                    <ul className="list-disc list-inside space-y-2 mt-4 text-gray-300 pl-4">
                        <li><strong>1. new Binding</strong> (The Constructor Rule)</li>
                        <li><strong>2. Explicit Binding</strong> (The "I'm Telling You" Rule)</li>
                        <li><strong>3. Implicit Binding</strong> (The "Left of the Dot" Rule)</li>
                        <li><strong>4. Default Binding</strong> (The Fallback)</li>
                    </ul>

                    <div className="mt-16 mb-8 pt-8 border-t border-gray-800/60">
                        <h4 className="text-2xl sm:text-3xl font-black text-white mb-6">Interactive Context Explorer</h4>
                        <p className="text-gray-400 mb-8 font-medium">Use the interactive simulator below to see how the engine evaluates <code>this</code> under different calling rules!</p>
                        <JsThisKeywordSimulator />
                    </div>
                ...
                <div className="mt-16 sm:mt-24 pt-8 sm:pt-12 border-t border-gray-800/60 text-center relative w-full">
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-6 sm:gap-4 w-full max-w-2xl mx-auto">
                        <Link to="/webdevelopment/javascript/scope-chain" className="group flex items-center gap-3 sm:gap-4 p-4 sm:p-5 rounded-xl sm:rounded-2xl bg-black/20 border border-gray-800 hover:border-gray-600 transition-all duration-300 w-full sm:w-auto self-start sm:self-auto order-2 sm:order-1">
                            ...
                            <div className="text-left w-full h-full">
                                ...
                                <span className="text-gray-300 font-bold text-xs sm:text-sm">The Scope Chain</span>
                            </div>
                        </Link>

                        <Link to="/webdevelopment/javascript/new-binding" className="group flex items-center gap-3 sm:gap-4 p-4 sm:p-5 rounded-xl sm:rounded-2xl bg-[#0a0c10] border border-gray-800 hover:border-yellow-500/50 hover:shadow-[0_0_30px_rgba(168,85,247,0.1)] transition-all duration-300 w-full sm:w-auto order-1 sm:order-2">
                            <div className="text-right w-full h-full">
                                ...
                                <span className="text-gray-200 font-bold text-xs sm:text-sm group-hover:text-white transition-colors">The new Binding</span>
                            </div>
