    ...
    <div>
      ...
      >
        ...
        <p className="text-lg md:text-xl text-gray-300 leading-relaxed mb-10">
          At <span className="font-semibold text-cyan-400">Tech Spread</span>, we are a passionate team of innovators, educators, and developers united by one mission — to make computer science education simple, practical, and accessible to everyone.
