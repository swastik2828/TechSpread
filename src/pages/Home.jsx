        ...
        {loading ? (
          ...
          >
            ...
            <motion.div
              ...
              className="text-4xl md:text-6xl font-extrabold tracking-wide bg-gradient-to-r from-purple-400 via-blue-400 to-pink-400 bg-clip-text text-transparent"
            >
              TechSpread
            </motion.div>
            ...
            <motion.div
              className="mt-10 relative w-16 h-16"
              animate={{ rotate: 360 }}
              transition={{ duration: 2, repeat: Infinity, ease: "linear" }}
            >
              <div className="absolute inset-0 rounded-full border-t-4 border-b-4 border-purple-500" />
              <div className="absolute inset-2 rounded-full border-t-4 border-b-4 border-blue-500 opacity-60" />
            </motion.div>

            <motion.p
              className="mt-8 text-gray-400 text-sm tracking-widest uppercase"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          <motion.div
            ...
            exit={{ opacity: 0 }}
            transition={{ duration: 0.8 }}
            className="bg-gradient-to-b from-[#0f172a] to-[#111827]"
          >
